...
| footer             | A custom footer component for the form. Use this if the default footer is not sufficient. [Read more](/custom-footer)  | Optional |
| buttons            | Add custom buttons to customize form buttons in footer section. [Read more](/custom-footer/#customize-footer-buttons) | Optional |
