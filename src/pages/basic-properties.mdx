...
| onNext             | A function that will be called when when the user attempts to navigate to the next section of a grouped form. For async data, use property `useNextResponse` as true                                                                                                                                                                         | Optional  |
...
| useNextResponse    | Setting this to true ensures that the onNext call will wait for a server response before proceeding. | Optional |
