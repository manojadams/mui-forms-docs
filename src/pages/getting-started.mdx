...
| Feature | Benefit |
|---------|---------|
| **JSON-based Schema** | Define forms without JSX - easier to maintain and test |
| **Material-UI Components** | Beautiful, responsive fields powered by MUI |
| **Built in layouting** | Out of the box layouting support | 
| **Conditional Logic** | Show/hide fields, define advanced field dependencies without writing any code  |
| **API Integration** | Load dropdown options using api |
